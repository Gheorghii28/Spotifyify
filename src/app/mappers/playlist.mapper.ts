...
export class PlaylistMapper {
  public static toModel(dto: SpotifyPlaylistDto | SpotifyUserPlaylistItemDto): Playlist {
    return {
      id: dto.id,
      name: dto.name,
      description: dto.description,
      color: dto.primary_color || '#FFFFFF', // Default to white if null
      type: dto.type,
      ...
      tracks: 'items' in dto.tracks && Array.isArray(dto.tracks.items)
